...
#
# SJH Changed from per directory to per file function
# SJH Changed variable names to be human readable
###########################################################################
...
form Counting Syllables in Sound Utterances
   ...
   sentence fileName /filenotspecified
endform
...
printline soundname, syllables, pauses, duration, phonation_time, speech_rate, articulation_rate, average_syllable_duration
